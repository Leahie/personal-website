...
description: Nested visual workspace and every creative's first project. Built with React, ExpressJS, and FirebaseDB. 
---
...
import BoardBlock from "@/assets/documents/boardbash/boardblockrel.png";
...
<BlogImage src={BoardBlock} alt="Root boards are identified by null parentBoardBlockIds." />
