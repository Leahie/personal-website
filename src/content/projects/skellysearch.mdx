...
description: Sketch to pose art reference finder built with React and FastAPI, hosted on AWS, motivated by lack of anatomically accurate pose searchers.
---
...
import Sketch2Pose from "@/assets/documents/skellysearch/sketch2pose.png";
import Heatmap from "@/assets/documents/skellysearch/heatmap.png";
...
<BlogImage src={GoogleSearch} alt="Example google search: Person sitting 130 degrees from the side." />
...
### Sketch Models
There are preexisting sketch-to-pose models like [Sketch2PoseNet](https://dl.acm.org/doi/10.1145/3757377.3763855) and [Sketch2Pose](https://www-labs.iro.umontreal.ca/~bmpix/sketch2pose/), but the Sketch2PoseNet's models aren't publicly released and I wanted to specialize my model toward one type of sketch input.
...
<BlogImage src={Sketch2Pose} alt="Inference results from Heatmap and GAT models " />

So I wanted the input to look like a stick figure and still contain enough information about the pose. Since there wasn't preexisting data for my goal online, I artificially created the data using the [COCO 2014](https://cocodataset.org/#home) dataset (27,237 images) for training and [LSP-EXTENDED](https://dbcollection.readthedocs.io/en/latest/datasets/leeds_sports_pose_extended.html) dataset (9,428 images) for evaluation.

#### Architecture
<BlogImage src={Heatmap} alt="Heatmap - PoseCNN + SkeletonGNN" />
...
<PdfEmbed
  src="/documents/skellysearch/skellysearch-1.pdf"
  title="skellysearch document 1"
  label="Open skellysearch document 1"
/>

<PdfEmbed
  src="/documents/skellysearch/skellysearch-2.pdf"
  title="skellysearch document 2"
  label="Open skellysearch document 2"
/>
